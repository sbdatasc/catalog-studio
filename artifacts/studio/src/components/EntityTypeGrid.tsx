import { type CatalogTemplate, type ApiError } from "@/lib/apiClient";
    ...
    return (
      <div className="rounded-2xl border border-dashed border-border p-12 flex flex-col items-center justify-center text-center bg-card/50">
        ...
        <p className="text-muted-foreground max-w-sm mb-6">
          {emptyMessage ?? "Create your first template to get started."}
        </p>
        <Button onClick={handleCreate} data-testid="button-new-template-empty">
          New Template
        </Button>
      </div>
    );
